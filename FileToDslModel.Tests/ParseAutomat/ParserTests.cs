...
namespace FileToDslModel.Tests.ParseAutomat
{
    ...
    public class ParserTests
    {
        ...
        [TestMethod]
        public void Parse_ClassWithProperty_Exception()
        {
        ...
        [TestMethod]
        public void Parse_ClassWithProperty_ExceptionAfterOPening()
        {
        ...
        [TestMethod]
        public void Parse_ClassWithProperty_ExceptionAfterPropertyTypeDefSeparator()
        {
        ...
        [TestMethod]
        public void Parse_ClassWithMethod_Exception()
        {
            var tokens = new Collection<DslToken>
            {
                new DslToken(TokenType.DomainClass, "DomainClass", 1),
        ...
        [TestMethod]
        public void Parse_ClassWithMethod_ExceptionAfterName()
        {
            var tokens = new Collection<DslToken>
            {
                new DslToken(TokenType.DomainClass, "DomainClass", 1),
        ...
        [TestMethod]
        public void Parse_ClassWithMethod_SingleParameter_Exception()
        {
            var tokens = new Collection<DslToken>
            {
                new DslToken(TokenType.DomainClass, "DomainClass", 1),
        ...
        [TestMethod]
        public void Parse_ClassWithMethod_SingleParameter_ExceptionParamClause()
        {
            var tokens = new Collection<DslToken>
            {
                new DslToken(TokenType.DomainClass, "DomainClass", 1),
        ...
        [TestMethod]
        public void Parse_ClassWithMethod_SingleParameter_ExceptionAfterFinishedParam()
        {
            var tokens = new Collection<DslToken>
            {
                new DslToken(TokenType.DomainClass, "DomainClass", 1),
        ...
        [TestMethod]
        public void Parse_ClassWithMethod_MultipleParameter_ExceptionNewParameter()
        {
            var tokens = new Collection<DslToken>
            {
                new DslToken(TokenType.DomainClass, "DomainClass", 1),
        ...
        [TestMethod]
        public void Parse_ClassWithMethod_EventWithProperties_ExceptionAfterTypeDef()
        {
            var tokens = new Collection<DslToken>
            {
                new DslToken(TokenType.DomainClass, "DomainClass", 1),
        ...
        [TestMethod]
        public void Parse_ClassWithMethod_EventWithProperties_ExceptionAfterEventOpening()
        {
            var tokens = new Collection<DslToken>
            {
                new DslToken(TokenType.DomainClass, "DomainClass", 1),
        ...
        [TestMethod]
        public void Parse_ClassWithMethod_EventWithProperties_ExceptionAfterEventProp()
        {
            var tokens = new Collection<DslToken>
            {
                new DslToken(TokenType.DomainClass, "DomainClass", 1),
        ...
        [TestMethod]
        public void Parse_ClassWithMethod_EventWithProperties_ExceptionAfterEventPropTypeDef()
        {
            var tokens = new Collection<DslToken>
            {
                new DslToken(TokenType.DomainClass, "DomainClass", 1),
        ...
        [TestMethod]
        public void Parse_ClassWithMethod_EventWithProperties_ExceptionAfterEventPropFinished()
        {
            var tokens = new Collection<DslToken>
            {
                new DslToken(TokenType.DomainClass, "DomainClass", 1),
        ...
        [TestMethod]
        public void Parse_ClassWithMethod_EventWithProperties_EventException()
        {
            var tokens = new Collection<DslToken>
            {
                new DslToken(TokenType.DomainClass, "DomainClass", 1),
        ...
        [TestMethod]
        public void Parse_ClassWithMethod_EventWithProperties_Exception()
        {
            var tokens = new Collection<DslToken>
            {
                new DslToken(TokenType.DomainClass, "DomainClass", 1),
        ...
        [TestMethod]
        public void Parse_ClassWithListProperty_Exception()
        {
            var tokens = new Collection<DslToken>
            {
                new DslToken(TokenType.DomainClass, "DomainClass", 1),
        ...
        [TestMethod]
        public void Parse_ClassWithListProperty_TypeDefException()
        {
            var tokens = new Collection<DslToken>
            {
                new DslToken(TokenType.DomainClass, "DomainClass", 1),
